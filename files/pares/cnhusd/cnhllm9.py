...
║  Port: 8765 (TCP Server) | Pure Python + Optional Ollama | <100ms latency   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM9:
    ...
    def __init__(self):
        self.port = 8765  # CNHUSD LLM9 PREDATOR
        ...
        log.info(f"[LLM9] Port: 8765 | Hybrid: Deterministic + Ollama Context")
