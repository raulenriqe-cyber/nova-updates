...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  🦘 IMPERIAL DRAGON SOUND ENGINE - Edge-TTS Neural Voices                    ║
║  by Polarice Labs © 2026                                                     ║
╠══════════════════════════════════════════════════════════════════════════════╣
║  Premium Female Voice: NatashaNeural (Australian English)                    ║
║  200+ Jocose Arrogant Yuan Trading Phrases | Emotion-based Speech Rate    ║
║  PORT 8770 - CNHUSD Carry Commodity Forger                                   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
# ============ CONFIGURATION ============
PORT = 8770  # ⭐ MUST match cnhquantum_core.py (87xx range)
LOG_FILE = Path(__file__).parent / "logs" / "cnhsound_engine.log"
...
# 🦘 Australian English Voice - Natasha (warm, confident, Yuan accent)
...
PHRASES = {
    'BUY': [
        ...
        "Fair dinkum gold right here! The Yuan dollar's about to go walkabout NORTH!",
        ...
        "Strewth! The Yuan's pumping harder than a V8 Supercar at Bathurst - ALL IN!",
        ...
        "Deadset legend setup! China's buying our dirt - we're buying the Yuan!",
        "Reckon this trade's gonna fly higher than a galah in a cyclone!",
        "Chuck a U-ey on your bearish bias - the Yuan's going UP, champion!",
        "Fair suck of the sav! This is the ripperest BUY signal since the gold rush!",
        "Yuan Yuan Yuan! The dollar's pumping harder than a Bintang night in Bali!",
        "Beijing's stimulus just dropped - grab the Yuan like it's the last pie at the servo!",
        ...
        "By the power of Vegemite! CNHUSD is about to rip faces off! BUY!",
        ...
        "This Yuan dollar is tougher than a two-dollar steak - it's going UP!",
        "RBA holding steady? No worries - that's our cue to BUY, legends!",
        "Copper prices through the roof! The Yuan's gonna fly, deadset!",
        "Not here to muck around - buying harder than a bogan at Bunnings on a Saturday!",
        "The smart money's loading up on Yuan like it's happy hour at the RSL!",
        "China PMI is pumping - the Yuan's about to go absolutely mental! BUY!",
        "Oi! Gold just broke out! The Yuan's riding shotgun to profit town!",
        "This is the way, mate! Buying CNHUSD with the swagger of a king parrot!",
        "Yeeeew! This BUY signal is more exciting than catching a wave at Snapper Rocks!",
        "The Yuan battler is about to become the Yuan BALLER - get on board!",
        "Deadset, this trade is surer than a meat pie at the footy! BUY!",
        "Like finding a parking spot at Bondi - rare and GOLDEN! We BUY!",
        "The Southern Cross is aligned - CNHUSD to the bloody moon, mate!",
    ...
    'SELL': [
        ...
        "Abandon ship, ya drongo! The Yuan's sinking like a stone in the Yarra!",
        ...
        "Strewth! Iron ore just tanked - the Yuan's gonna cop it sweet! SELL!",
        "China sneezed and China caught pneumonia - SELL THE AUSSIE!",
        ...
        "The Yuan's dropping like flies at a outback barbie - EXIT NOW!",
        ...
        "Beijing put the brakes on - Yuan's gonna drop like a lead balloon!",
        ...
        "She's buggered, mate! Time to cut our losses like a true blue Yuan!",
        ...
        "Risk off, mate! The Yuan's softer than a Sydneysider in winter!",
        ...
        "The Yuan's weaker than a VB at a craft beer festival - GET OUT!",
    ...
    'TP': [
        ...
        "Take profit, you magnificent bastard! The Yuan delivered like a Menulog driver!",
        "We just made coin faster than a pokies machine at the local! WINNER!",
        "Iron ore profits! Gold profits! CNHUSD profits! Triple bloody crown!",
        ...
        "We just turned Yuan dollars into MORE Yuan dollars! Genius, pure genius!",
        ...
        "China's finest export: OUR GAINS! Take profit, absolute champion!",
        ...
        "Commodity king status ACHIEVED! The Yuan treated us like royalty!"
    ],
    'SL': [
        ...
        "Down but NOT out! We're Yuan, we bounce back like a rubber thong!",
    ...
    'HOLD': [
        "Holding like a true blue Yuan - patient as a croc waiting for prey.",
        ...
        "Yuan patience mode - harder than waiting for the Ashes result.",
...
# ============ PLAY ALERT ============
def play_alert(action, symbol='CNHUSD'):
    """Play audio alert with Yuan flair"""
    action = action.upper()
...
def handle_client(sock, addr):
    try:
        ...
        symbol = data.get('symbol', 'CNHUSD').upper()
...
def main():
    ...
    try:
        ...
        print("\n" + "="*60)
        print("  🦘 IMPERIAL DRAGON SOUND ENGINE - Yuan TTS")
        print("  🐨 Carry Commodity Forger | CNHUSD")
        print("="*60)
        print(f"  ✓ Listening on 127.0.0.1:{PORT}")
        print(f"  ✓ TTS Engine: {'edge-tts (Neural)' if TTS_AVAILABLE else 'winsound (Beeps)'}")
        print(f"  ✓ Voice: {VOICE} (Australian Natasha)")
        print("="*60)
        print("\n  [READY] Waiting for alerts from cnhquantum_core.py...\n")
