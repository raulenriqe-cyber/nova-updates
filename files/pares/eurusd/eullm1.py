...
# ═══════════════════════════════════════════════════════════════════════════
try:
    from eu_config_loader import get_llm_port, get_sound_port
...
def run_tcp_server():
    ...
    # Load port from euconfig.yaml or use default
    global EU_CONFIG_LOADED
    if EU_CONFIG_LOADED:
        try:
            port = get_llm_port(1)  # LLM1 = 6555 from YAML
        except:
            port = 6555
    else:
        port = 6555  # EURUSD LLM1 default port
