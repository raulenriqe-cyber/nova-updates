...
║  Port: 7861 (TCP Server) - USDJPY M15                                        ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
import sys, os
...
# ============ CONFIGURACIÓN USDJPY M15 ============
HOST = '127.0.0.1'
PORT = 7861  # USDJPY LLM5 port (FIXED: was 7859, skips 7860)
MAX_CANDLES = 500
BUFFER_SIZE = 65536
...
class LLM5ChartAnalyzer:
    ...
    def analyze(self, symbol='USDJPY', timeframe='M15') -> Dict[str, Any]:
        ...
        # ═══════════════════════════════════════════════════════════════
        # USDJPY M15: Movimientos más pequeños que el oro
        ...
        # USDJPY M15: 0.0005 = 5 pips de movimiento
        ...
        # Momentum fuerte confirmado (USDJPY: 8+ pips es fuerte en M15)
...
class LLM5Client:
    ...
    @staticmethod
    def analyze(symbol='USDJPY', timeframe='M15', candles=None):
