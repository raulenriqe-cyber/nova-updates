...
# ============ CONFIGURATION ============
PORT = 8670  # ⭐ MUST match quantum_core.py
...
PHRASES = {
    ...
    'SL': [
        ...
        "All my money is in FOREX now – living the dream, dying inside.",
    ...
    'SELL': [
        ...
        "Goodbye, FOREX – hello, savings account.",
...
# ============ PLAY ALERT ============
def play_alert(action, symbol='USDSEK'):
    """Play audio alert"""
    action = action.upper()
...
def handle_client(sock, addr):
    try:
        ...
        symbol = data.get('symbol', 'USDSEK').upper()
