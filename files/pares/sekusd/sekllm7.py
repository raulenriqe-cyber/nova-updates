...
║  Port: 8663 (TCP Server) | Pure Python | Low Latency                         ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class OCULUS:
    ...
    def __init__(self):
        self.port = 8663  # USDSEK LLM7 OCULUS
        ...
        log.info("[OCULUS] \u2728 Data Quality Validator initialized (Port 8663 USDSEK)")
    ...
    def _detect_anomalies(self, data):
        ...
        try:
            ...
            closes = data.get('prices', data.get('closes', data.get('bar_data', {}).get('closes', [])))
