...
║  Port: 8659 (TCP Server) - Dynamic Risk Management with AI Learning          ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM4RiskManager:
    ...
    def analyze(self, data):
        ...
        try:
            ...
            # PHASE 10: RR ratio validation relaxed for exotic pair
            if confidence >= 75:
            ...
            # PHASE 10: Lower minimum confidence
...
def run_tcp_server():
    ...
    try:
        ...
        port = config.get('llm_settings', {}).get('llm4_port', 8659)
    except:
        port = 8659  # LLM4 is RISK on port 8659
