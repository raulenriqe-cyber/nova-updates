...
║  Port: 5562 (TCP Server) | Pure Python | Low Latency                         ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class OCULUS:
    ...
    def __init__(self):
        ...
        log.info("[OCULUS] ✨ Data Quality Validator initialized (Port 5562)")
    ...
    def _detect_anomalies(self, data):
        ...
        try:
            ...
            # ⭐ FIX: Trinity sends 'prices' not 'closes' at root level
