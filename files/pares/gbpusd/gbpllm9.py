...
║  Port: 7565 (TCP Server) | Pure Python + Optional Ollama | <100ms latency   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM9:
    ...
    def __init__(self):
        self.port = 7565  # GBPUSD LLM9 PREDATOR
        ...
        log.info(f"[LLM9] Port: 7565 | Hybrid: Deterministic + Ollama Context")
