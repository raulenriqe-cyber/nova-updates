...
║  Port: 8959 (TCP Server) - Dynamic Risk Management with AI Learning          ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM4RiskManager:
    ...
    def analyze(self, data):
        ...
        try:
            ...
            risk_dollars = price * risk_pips  # Approximate dollar risk for US30 index
...
def run_tcp_server():
    ...
    try:
        ...
        port = config.get('llm_settings', {}).get('llm4_port', 8959)
    except:
        port = 8959  # LLM4 is RISK on port 8959
