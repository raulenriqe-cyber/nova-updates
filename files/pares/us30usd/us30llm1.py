...
{Y}|{R}                                                              {Y}|{R}
{Y}+{'-'*62}+{R}
{Y}|{R}  {W}US30 Scalping Edition{R}      {D}by Polarice Labs © 2026{R}       {Y}|{R}
...
def run_tcp_server():
    ...
    # Cargar puerto desde us30config.yaml
    try:
        with open('us30config.yaml', 'r') as f:
            config = yaml.safe_load(f) or {}
        port = config.get('llm_settings', {}).get('llm1_port', 8955)
    except:
        port = 8955  # Fallback
