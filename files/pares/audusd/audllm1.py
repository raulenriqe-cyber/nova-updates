...
{Y}|{R}                                                              {Y}|{R}
{Y}+{'-'*62}+{R}
{Y}|{R}  {W}AUDUSD Scalping Edition{R}      {D}by Polarice Labs © 2026{R}       {Y}|{R}
...
def run_tcp_server():
    ...
    # Cargar puerto desde audconfig.yaml
    try:
        with open('audconfig.yaml', 'r') as f:
            config = yaml.safe_load(f) or {}
        port = config.get('llm_settings', {}).get('llm1_port', 8555)
    except:
        port = 8555  # Fallback
