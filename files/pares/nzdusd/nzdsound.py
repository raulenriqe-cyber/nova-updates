...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  🦘 KIWI SOVEREIGN SOUND ENGINE - Edge-TTS Neural Voices                    ║
...
║  PORT 9270 - NZDUSD Carry Commodity Forger                                   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
# ============ CONFIGURATION ============
PORT = 9270  # ⭐ MUST match nzdquantum_core.py (92xx range)
LOG_FILE = Path(__file__).parent / "logs" / "nzdsound_engine.log"
...
PHRASES = {
    'BUY': [
        ...
        "By the power of Vegemite! NZDUSD is about to rip faces off! BUY!",
        ...
        "This is the way, mate! Buying NZDUSD with the swagger of a king parrot!",
        ...
        "The Southern Cross is aligned - NZDUSD to the bloody moon, mate!",
    ...
    'TP': [
        ...
        "Iron ore profits! Gold profits! NZDUSD profits! Triple bloody crown!",
...
# ============ PLAY ALERT ============
def play_alert(action, symbol='NZDUSD'):
...
def handle_client(sock, addr):
    try:
        ...
        symbol = data.get('symbol', 'NZDUSD').upper()
...
def main():
    ...
    try:
        ...
        print("\n" + "="*60)
        print("  🦘 KIWI SOVEREIGN SOUND ENGINE - Aussie TTS")
        print("  🐨 Carry Commodity Forger | NZDUSD")
        print("="*60)
        print(f"  ✓ Listening on 127.0.0.1:{PORT}")
        print(f"  ✓ TTS Engine: {'edge-tts (Neural)' if TTS_AVAILABLE else 'winsound (Beeps)'}")
        print(f"  ✓ Voice: {VOICE} (Australian Natasha)")
        print("="*60)
        print("\n  [READY] Waiting for alerts from nzdquantum_core.py...\n")
