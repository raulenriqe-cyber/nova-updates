...
class RealQLearningAgent:
    ...
    def learn_from_trade(self, entry_state, action, exit_price, entry_price, tp, sl, trade_duration):
        ...
        """
        # CALCULATE RAW P&L
        # [NOVA REPAIR ARCHITECT - FIX CRÍTICO] C-03: BTCUSD 1 point = 1.0 so factor = 1 (was 10000)
        pnl_pips = (exit_price - entry_price) * 1
        risk_pips = (entry_price - sl) * 1 if action == 'BUY' else (sl - entry_price) * 1
