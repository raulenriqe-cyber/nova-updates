...
║  Ports: 8865 (BTCUSD) | 6565 (EURUSD) | Pure Python | <100ms latency        ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class NOVA:
    ...
    def __init__(self, port=8865, symbol='BTCUSD'):
        self.port = port
        self.symbol = symbol
    ...
    def _audit_correlation_risks(self, symbol: str, genome: dict) -> list:
        ...
        alerts = []
        try:
            # Para BTCUSD: correlación con DXY
            if symbol == 'BTCUSD':
...
if __name__ == '__main__':
    ...
    symbol = 'BTCUSD' if port == 8865 else 'EURUSD'
