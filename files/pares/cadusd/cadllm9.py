...
║  Port: 9165 (TCP Server) | Pure Python + Optional Ollama | <100ms latency   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM9:
    ...
    def __init__(self):
        self.port = 9165  # USDCAD LLM9 PREDATOR
        ...
        log.info(f"[LLM9] Port: 9165 | Hybrid: Deterministic + Ollama Context")
        ...
        try:
            ...
            if consensus_confidence >= 65 and consensus_decision in ['BUY', 'SELL']:
                if quality_score >= 50 and rr_ratio >= 1.5:
                    ...
                    log.info(f"[LLM9] ⏳ {decision} (conditions sub-optimal)")
            else:
                decision = 'HOLD'
