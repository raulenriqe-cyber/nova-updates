...
"""
╔══════════════════════════════════════════════════════════════════════════════╗
║  🦘 MAPLE SOVEREIGN SOUND ENGINE - Edge-TTS Neural Voices                    ║
...
║  PORT 9170 - USDCAD Carry Commodity Forger                                   ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
# ============ CONFIGURATION ============
PORT = 9170  # ⭐ MUST match cadquantum_core.py (85xx range)
LOG_FILE = Path(__file__).parent / "logs" / "cadsound_engine.log"
...
PHRASES = {
    'BUY': [
        ...
        "By the power of Vegemite! USDCAD is about to rip faces off! BUY!",
        ...
        "This is the way, mate! Buying USDCAD with the swagger of a king parrot!",
        ...
        "The Southern Cross is aligned - USDCAD to the bloody moon, mate!",
    ...
    'TP': [
        ...
        "Iron ore profits! Gold profits! USDCAD profits! Triple bloody crown!",
...
# ============ PLAY ALERT ============
def play_alert(action, symbol='USDCAD'):
...
def handle_client(sock, addr):
    try:
        ...
        symbol = data.get('symbol', 'USDCAD').upper()
...
def main():
    ...
    try:
        ...
        print("\n" + "="*60)
        print("  🦘 MAPLE SOVEREIGN SOUND ENGINE - Aussie TTS")
        print("  🐨 Carry Commodity Forger | USDCAD")
        print("="*60)
        print(f"  ✓ Listening on 127.0.0.1:{PORT}")
        print(f"  ✓ TTS Engine: {'edge-tts (Neural)' if TTS_AVAILABLE else 'winsound (Beeps)'}")
        print(f"  ✓ Voice: {VOICE} (Australian Natasha)")
        print("="*60)
        print("\n  [READY] Waiting for alerts from cadquantum_core.py...\n")
