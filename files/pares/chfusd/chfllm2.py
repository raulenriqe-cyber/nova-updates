...
║  Port: 8602 (TCP Server) - NEVER FAILS, ALWAYS RESPONDS                      ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class LLM2TechnicalExpert:
    ...
    def __init__(self):
        ...
        self.memory = {'USDCHF': deque(maxlen=300)}
...
def start_server():
    """Inicia servidor TCP en puerto 8602"""
    try:
        ...
        port = config.get('llm_settings', {}).get('llm2_port', 8602)
