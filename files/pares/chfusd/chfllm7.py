...
║  Port: 8608 (TCP Server) | Pure Python | Low Latency                         ║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
...
class OCULUS:
    ...
    def __init__(self):
        ...
        log.info("[OCULUS] ✨ Data Quality Validator initialized (Port 8608)")
    ...
    def _check_data_integrity(self, data):
        ...
        try:
            ...
            # 🔴 FIX: Use strict > 0 check to detect real vs default values
            ...
            if isinstance(volumes, list) and len(volumes) > 0:
                ...
                # No volume data available - don't penalize (M1 forex often lacks tick volume)
